    ...
    implements IClassTransformer
{
    ...
    private void transformTeleportTo(MethodNode method) {
        ...
        needle.add(new InsnNode(Opcodes.F2D));
        needle.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/world/World", ASMNames.M_spawnParticle, "(Ljava/lang/String;DDDDDD)V"));
        ...
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/world/World", ASMNames.M_spawnParticle, "(Ljava/lang/String;DDDDDD)V"));
        newInstr.add(l17);
