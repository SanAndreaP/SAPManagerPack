        ...
        implements IClassTransformer
{
    ...
    private static void transformTeleportTo(MethodNode method) {
        ...
        needle.add(new InsnNode(Opcodes.F2D));
        needle.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/world/World", ASMNames.M_spawnParticle, "(Ljava/lang/String;DDDDDD)V", false));
        ...
        newInstr.add(new MethodInsnNode(Opcodes.INVOKESPECIAL, "de/sanandrew/core/manpack/util/event/entity/EnderSpawnParticleEvent", "<init>", "(Lnet/minecraft/entity/monster/EntityEnderman;DDDDDDLde/sanandrew/core/manpack/util/event/entity/EnderSpawnParticleEvent$EnderParticleType;)V", false));
        ...
        newInstr.add(new LabelNode());
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_worldObj, "Lnet/minecraft/world/World;"));
        newInstr.add(new LdcInsnNode("portal"));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 31));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "de/sanandrew/core/manpack/util/event/entity/EnderSpawnParticleEvent", "getX", "()D", false));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 31));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "de/sanandrew/core/manpack/util/event/entity/EnderSpawnParticleEvent", "getY", "()D", false));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 31));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "de/sanandrew/core/manpack/util/event/entity/EnderSpawnParticleEvent", "getZ", "()D", false));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 31));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "de/sanandrew/core/manpack/util/event/entity/EnderSpawnParticleEvent", "getD1", "()D", false));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 31));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "de/sanandrew/core/manpack/util/event/entity/EnderSpawnParticleEvent", "getD2", "()D", false));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 31));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "de/sanandrew/core/manpack/util/event/entity/EnderSpawnParticleEvent", "getD3", "()D", false));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/world/World", ASMNames.M_spawnParticle, "(Ljava/lang/String;DDDDDD)V", false));
        newInstr.add(l17);
    ...
    private static void transformOnLivingUpdate(MethodNode method) {
        ...
        needle.add(new LdcInsnNode("portal"));
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_posX, "D"));
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_rand, "Ljava/util/Random;"));
        needle.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "java/util/Random", "nextDouble", "()D", false));
        needle.add(new LdcInsnNode(new Double("0.5")));
        needle.add(new InsnNode(Opcodes.DSUB));
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_width, "F"));
        needle.add(new InsnNode(Opcodes.F2D));
        needle.add(new InsnNode(Opcodes.DMUL));
        needle.add(new InsnNode(Opcodes.DADD));
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_posY, "D"));
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_rand, "Ljava/util/Random;"));
        needle.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "java/util/Random", "nextDouble", "()D", false));
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_height, "F"));
        needle.add(new InsnNode(Opcodes.F2D));
        needle.add(new InsnNode(Opcodes.DMUL));
        needle.add(new InsnNode(Opcodes.DADD));
        ...
        needle.add(new InsnNode(Opcodes.DSUB));
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_posZ, "D"));
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_rand, "Ljava/util/Random;"));
        needle.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "java/util/Random", "nextDouble", "()D", false));
        needle.add(new LdcInsnNode(new Double("0.5")));
        ...
        newInstr.add(new LdcInsnNode("portal"));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_posX, "D"));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_rand, "Ljava/util/Random;"));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "java/util/Random", "nextDouble", "()D", false));
        newInstr.add(new LdcInsnNode(new Double("0.5")));
        newInstr.add(new InsnNode(Opcodes.DSUB));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_width, "F"));
        newInstr.add(new InsnNode(Opcodes.F2D));
        newInstr.add(new InsnNode(Opcodes.DMUL));
        newInstr.add(new InsnNode(Opcodes.DADD));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_posY, "D"));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_rand, "Ljava/util/Random;"));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "java/util/Random", "nextDouble", "()D", false));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_height, "F"));
        newInstr.add(new InsnNode(Opcodes.F2D));
        newInstr.add(new InsnNode(Opcodes.DMUL));
        newInstr.add(new InsnNode(Opcodes.DADD));
        ...
        newInstr.add(new InsnNode(Opcodes.DSUB));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_posZ, "D"));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/monster/EntityEnderman", ASMNames.F_rand, "Ljava/util/Random;"));
        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "java/util/Random", "nextDouble", "()D", false));
        newInstr.add(new LdcInsnNode(new Double("0.5")));
