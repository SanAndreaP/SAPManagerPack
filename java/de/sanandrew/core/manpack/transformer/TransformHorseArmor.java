        ...
        implements IClassTransformer
{
    ...
    private static byte[] transformHorse(byte[] bytes) {
        ...
        transformInteract(ASMHelper.findMethod(clazz, ASMNames.MDO_HORSE_INTERACT));
        transformIsValidArmor(ASMHelper.findMethod(clazz, ASMNames.MDO_HORSE_FUNC146085A));
        transformEntityInit(ASMHelper.findMethod(clazz, ASMNames.MDO_HORSE_ENTITY_INIT));
        transformUpdateHorseSlots(ASMHelper.findMethod(clazz, ASMNames.MDO_HORSE_FUNC110232CE));
        transformOnInvChanged(ASMHelper.findMethod(clazz, ASMNames.MDO_HORSE_ON_INV_CHANGED));
        transformGetTotalArmorValue(ASMHelper.findMethod(clazz, ASMNames.MDO_HORSE_GET_TOTAL_ARMOR_VAL));

        try {
            transformArmorTexture(ASMHelper.findMethod(clazz, ASMNames.MDO_HORSE_SET_TEXTURE_PATH));
    ...
    private static MethodNode injectMethodGetCustomArmorItem() {
        ...
        ASMHelper.visitFieldInsn(method, Opcodes.GETFIELD, ASMNames.FDO_ENTITY_DATAWATCHER, ASMNames.CL_ENTITY_HORSE);
        method.visitIntInsn(Opcodes.BIPUSH, 23);
        ASMHelper.visitMethodInsn(method, Opcodes.INVOKEVIRTUAL, ASMNames.MDO_DATAWATCHER_GET_OBJ_STACK, false);
    ...
    private static MethodNode injectMethodSetCustomArmorItem() {
        ...
        ASMHelper.visitFieldInsn(method, Opcodes.GETSTATIC, ASMNames.FDO_ITEMS_IRON_SHOVEL);
        ...
        method.visitIntInsn(Opcodes.BIPUSH, 23);
        method.visitVarInsn(Opcodes.ALOAD, 1);
        ASMHelper.visitMethodInsn(method, Opcodes.INVOKEVIRTUAL, ASMNames.MDO_DATAWATCHER_UPDATE_OBJ, false);
        Label l3 = new Label();
    ...
    private static void transformGetTotalArmorValue(MethodNode method) {
        ...
        needle.add(ASMHelper.getFieldInsnNode(Opcodes.GETSTATIC, ASMNames.FDO_HORSE_ARMOR_VALUES));
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_HORSE_FUNC110241CB, false));
        ...
        newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_ITEMSTACK_GET_ITEM, false));
    ...
    private static void transformOnInvChanged(MethodNode method) {
        InsnList needle = new InsnList();
        needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
        needle.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_HORSE_IS_SADDLED, false));
        ...
        needle.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_ENTITY_PLAY_SOUND, ASMNames.CL_ENTITY_HORSE, false));
        needle.add(new LabelNode());
        ...
        newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_ITEMSTACK_GET_ITEM, false));
        newInstr.add(ASMHelper.getFieldInsnNode(Opcodes.GETSTATIC, ASMNames.FDO_ITEMS_IRON_SHOVEL));
        LabelNode l9 = new LabelNode();
        newInstr.add(new JumpInsnNode(Opcodes.IF_ACMPNE, l9));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 4));
        newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
        newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKESPECIAL, ASMNames.MD_SAP_GET_CUSTOM_ARMOR_ITEM, false));
        newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_ITEMSTACK_IS_ITEM_EQUAL, false));
        ...
        newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_ENTITY_PLAY_SOUND, ASMNames.CL_ENTITY_HORSE, false));
        newInstr.add(l9);
	...
	private static void transformArmorTexture(MethodNode method) {
	    ...
	    newInstr.add(l20);
	    newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
	    newInstr.add(ASMHelper.getFieldInsnNode(Opcodes.GETFIELD, ASMNames.FDO_HORSE_FIELD110280BR));
	    ...
	    newInstr.add(new VarInsnNode(Opcodes.ALOAD, 0));
	    newInstr.add(ASMHelper.getFieldInsnNode(Opcodes.GETFIELD, ASMNames.FDO_HORSE_FIELD110286BQ));
	    ...
	    newInstr.add(new VarInsnNode(Opcodes.ALOAD, 4));
	    newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_ITEMSTACK_GET_UNLOC_NAME, false));
        newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MD_STRINGBUILDER_APPEND, false));
	    newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MD_STRINGBUILDER_TO_STRING, false));
        newInstr.add(ASMHelper.getFieldInsnNode(Opcodes.PUTFIELD, ASMNames.FDO_HORSE_FIELD110286BQ));
	...
	private static void transformUpdateHorseSlots(MethodNode method) {
	    ...
	    needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
	    needle.add(new VarInsnNode(Opcodes.ALOAD, 0));
	    needle.add(ASMHelper.getFieldInsnNode(Opcodes.GETFIELD, ASMNames.FDO_HORSE_CHEST));
	    ...
	    newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_INVBASIC_GET_STACK_IN_SLOT, ASMNames.CL_ANIMAL_CHEST, false));
...
//        needle.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/passive/EntityHorse", ASMNames.F_dataWatcher, "Lnet/minecraft/entity/DataWatcher;"));
        needle.add(ASMHelper.getFieldInsnNode(Opcodes.GETFIELD, ASMNames.FDO_ENTITY_DATAWATCHER, ASMNames.CL_ENTITY_HORSE));
...
//        needle.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/entity/DataWatcher", ASMNames.M_addObject, "(ILjava/lang/Object;)V", false));
        needle.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_DATAWATCHER_ADD_OBJECT, false));
...
//        newInstr.add(new FieldInsnNode(Opcodes.GETFIELD, "net/minecraft/entity/passive/EntityHorse", ASMNames.F_dataWatcher, "Lnet/minecraft/entity/DataWatcher;"));
        newInstr.add(ASMHelper.getFieldInsnNode(Opcodes.GETFIELD, ASMNames.FDO_ENTITY_DATAWATCHER, ASMNames.CL_ENTITY_HORSE));
...
//        newInstr.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/entity/DataWatcher", ASMNames.M_addObject, "(ILjava/lang/Object;)V", false));
        newInstr.add(ASMHelper.getMethodInsnNode(Opcodes.INVOKEVIRTUAL, ASMNames.MDO_DATAWATCHER_ADD_OBJECT, false));
...
//	    needle.add(new FieldInsnNode(Opcodes.GETSTATIC, "net/minecraft/init/Items", ASMNames.F_iron_horse_armor, "Lnet/minecraft/item/Item;"));
	    needle.add(ASMHelper.getFieldInsnNode(Opcodes.GETSTATIC, ASMNames.FDO_ITEMS_HORSE_ARMOR_IRON));
...
//	    needle.add(new FieldInsnNode(Opcodes.GETSTATIC, "net/minecraft/init/Items", ASMNames.F_diamondHorseArmor, "Lnet/minecraft/item/Item;"));
        needle.add(ASMHelper.getFieldInsnNode(Opcodes.GETSTATIC, ASMNames.FDO_ITEMS_HORSE_ARMOR_DIAMOND));
