        ...
        implements IValue0<A>, IValue1<B>, IValue2<C>, IValue3<D>, IValue4<E>, IValue5<F>, IValue6<G>, IValue7<H>, IValue8<I>
{
    ...
    public static <X> Ennead<X, X, X, X, X, X, X, X, X> fromArray(final X[] array) {
        ...
        return new Ennead<>(array[0], array[1], array[2], array[3], array[4], array[5], array[6], array[7], array[8]);
    }
    ...
    private static <X> Ennead<X, X, X, X, X, X, X, X, X> fromIterable(final Iterable<X> iterable, int index, final boolean checkSize) {
        ...
        X element;
        ArrayList<X> elements = new ArrayList<>(9);
        ...
        return new Ennead<>(elements.get(0), elements.get(1), elements.get(2), elements.get(3), elements.get(4), elements.get(5), elements.get(6), elements.get(7),
                            elements.get(8)
        );
    }
